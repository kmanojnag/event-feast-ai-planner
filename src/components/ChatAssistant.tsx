...
const ChatAssistant = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-96 max-w-[calc(100vw-2rem)]">
      <Card className="shadow-2xl border-2" style={{ borderColor: '#df7234' }}>
        <CardHeader className="text-white rounded-t-lg" style={{ backgroundColor: '#df7234' }}>
            ...
            <div className="space-y-4">
              {messages.map((message) => (
                ...
                >
                  ...
                  style={message.sender === 'user' ? { backgroundColor: '#df7234' } : {}}
                  >
                    {message.sender === 'user' ? (
